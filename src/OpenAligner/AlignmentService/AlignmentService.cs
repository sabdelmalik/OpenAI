...
namespace AdvancedAligner
{
    public class AlignmentService
    {
        ...
        public AlignmentService(OpenAiService openAiService, HebrewBibleParser hebrewBibleParser, TahotParser taParser, TargetParser targetParser)
        {
        ...
        {
            string json = System.Text.Json.JsonSerializer.Serialize(verses, new JsonSerializerOptions
            {
                Encoder = JavaScriptEncoder.Create(UnicodeRanges.All),
                WriteIndented = false
            });
...
- A target token's index can appear only once
